...
namespace DataAccessLayer
{
    public class DAL
    {
        ...
        public DAL()
        {
            _SqlConn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\35192\OneDrive\Documentos\DB_Agenda.mdf;Integrated Security=True;Connect Timeout=30");
        }
